...
export const mockWashHistory: WashHistory[] = [
  ...
  },
  {
    ...
    washType: {
      ...
      features: ["Pre-soak", "High-pressure rinse", "Air dry"],
    },
    station: {
      id: "2",
    ...
    price: 79,
    paymentMethod: "Credit Card",
    services: ["Pre-soak", "High-pressure rinse", "Air dry"],
  },
  {
    id: "4",
