...
import { ArrowLeft, Clock, Heart, Navigation, Star, Car, Droplets, MapPin, Phone, CircleCheck as CheckCircle } from 'lucide-react-native';
  ...
  useEffect(() => {
    if (id) {
      ...
      if (foundStation) {
        ...
        setIsFavorite(foundStation.isFavorite);
      }
    }
  }, [id]);
                ...
                <View style={styles.badgeContainer}>
                  ...
                  <View style={[styles.badge, { backgroundColor: COLORS.primary[500] }]}>
                    <Text style={styles.badgeText}>
                      {station.type === 'manual' ? 'Manual Wash' : 'Automatic Wash'}
                    </Text>
                  </View>
                </View>
              </View>
          ...
          <View style={styles.sectionContainer}>
            ...
            >
              {mockWashTypes.map(washType => (
                ...
                >
                  <Image 
                    source={{ uri: washType.imageUrl }} 
                    style={styles.packageImage}
                  />
                  <View style={styles.packageContent}>
                    <Text style={styles.packageName}>{washType.name}</Text>
                    <Text style={styles.packageDescription} numberOfLines={2}>
                      {washType.description}
                    </Text>
                    <Text style={styles.packagePrice}>{washType.price} kr</Text>
                  </View>
                </TouchableOpacity>
              ))}
            </ScrollView>
