...
import { ArrowRight, Bell, Car, CreditCard, CircleHelp as HelpCircle, LogOut, Mail, MessageSquare, Settings, Shield, UserCog } from 'lucide-react-native';
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          >
            <View style={styles.membershipContent}>
              <View>
                ...
                <Text style={styles.membershipValidity}>Valid until Dec 31, 2023</Text>
              </View>
              <Image
                source={{ uri: 'https://images.pexels.com/photos/1144176/pexels-photo-1144176.jpeg' }}
        ...
        <View style={styles.section}>
          ...
          >
            <View style={styles.menuItemLeft}>
              <View style={[styles.menuItemIcon, { backgroundColor: COLORS.primary[100] }]}>
          ...
          >
            <View style={styles.menuItemLeft}>
              <View style={[styles.menuItemIcon, { backgroundColor: COLORS.teal[100] }]}>
          ...
          >
            <View style={styles.menuItemLeft}>
              <View style={[styles.menuItemIcon, { backgroundColor: COLORS.accent[100] }]}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.switchItem}>
            <View style={styles.menuItemLeft}>
              <View style={[styles.menuItemIcon, { backgroundColor: COLORS.warning[100] }]}>
          ...
          <View style={styles.switchItem}>
            ...
            <Switch
              trackColor={{ false: COLORS.gray[300], true: COLORS.primary[300] }}
              thumbColor={darkModeEnabled ? COLORS.primary[600] : COLORS.gray[100]}
        ...
        <View style={styles.section}>
          ...
          >
            <View style={styles.menuItemLeft}>
              <View style={[styles.menuItemIcon, { backgroundColor: COLORS.info[100] }]}>
          ...
          >
            <View style={styles.menuItemLeft}>
              <View style={[styles.menuItemIcon, { backgroundColor: COLORS.success[100] }]}>
